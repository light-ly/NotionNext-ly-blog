...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，here is the cyber home for Light-ly',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Light-ly', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'notion.light-liuyi.top', // 网站地址
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/light-ly', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  RANDOM_IMAGE_URL: process.env.NEXT_PUBLIC_RANDOM_IMAGE_URL || 'https://api.likepoems.com/img/pc', // 随机图片API,如果未配置下面的关键字，主页封面，头像，文章封面图都会被替换为随机图片
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '冀ICP备2022022291号', // 备案号 闽ICP备XXXXXXX
  ...
  PRISM_THEME_LIGHT_PATH:
    ...
    'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism-okaidia.min.css', // 浅色模式主题
  ...
  // twikoo
  // TwikooUser
  // LFX133#KVRt5ICPLua96Sb2
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://twikoo.light-liuyi.top', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-KPNX0PMC7S', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'Hi，here is the cyber home for Light-ly', // 站点描述，被notion中的页面描述覆盖
